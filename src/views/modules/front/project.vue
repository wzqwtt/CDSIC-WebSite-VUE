  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('front:project:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('front:project:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <!-- <el-table-column
        ...
        header-align="center"
        align="center"
        label="如果展示轮播图，这里写入顺序，默认不展示（值为-1）">
      </el-table-column> -->
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/front/project/list'),
          method: 'get',
      ...
      updateProjectStatus(data){
        ...
        // 发送请求，修改状态
        this.$http({
        url: this.$http.adornUrl('/front/project/update'),
        method: 'post',
        data: this.$http.adornData({pid:pid,piscarousel:piscarousel}, false)
        }).then(({ data }) => { 
          this.$message({
            type:"success",
            message:"状态更新成功"
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/front/project/delete'),
            method: 'post',
